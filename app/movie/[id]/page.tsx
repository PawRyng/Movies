        ...
        <section className="movie flex gap-4 flex-wrap sm:gap-1/12">
            ...
            <div className="contents sm:block sm:w-8/12 sm:order-2">
                ...
                <div className="avarage w-4/12 flex flex-col gap-2 pt-4 order-3 sm:max-w-max">
                    ...
                    {movie.adult && <p className="mt-6 flex items-center justify-center border-4 border-red-600 rounded-full aspect-square w-14 self-center">+18</p>}
                </div>
            <div className="description w-full order-4 mt-6">
                {movie.overview}
            </div>
            </div>
